        ...
        <>
            <div className="shadow-sm border-b sticky top-0 bg-white z-30">
                <div className="flex items-center justify-between max-w-6xl mx-auto space-x-4">
                    ...
                    <div className="flex items-center space-x-4">
                        <HomeIcon
                            className=" hidden md:inline-flex h-5 w-5 cursor-pointer hover:scale-125 transition-transform duration-200 ease-out"/>
                        <PlusCircleIcon
                            className="h-5 w-5 cursor-pointer hover:scale-125 transition-transform duration-200 ease-out"/>
                        <img
